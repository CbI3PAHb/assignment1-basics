...
python3 /Users/parii-artem/Documents/assignment1-basics/cs336_basics/tokenization/tokenization.py \
...
def bpeTrainingFunction(
    ...
    for new_token_index in tqdm.tqdm(
        ...
        # logger.debug(f"{len(pair_of_tokens_to_indexes)=}")
        ...
        word_indexes_where_new_byte_pair_exists: list[int] = list(
            pair_of_tokens_to_indexes[most_frequent_pair]
        )
        ...
        for word_index in word_indexes_where_new_byte_pair_exists:
            ...
            while i < len(current_byte_string):
                if (
                    i + 1 < len(current_byte_string)
                    and (current_byte_string[i] + current_byte_string[i + 1])
                    == new_byte_token
                ):
        ...
        log_data = {
            ...
            "pair_indexes_count": len(pair_of_tokens_to_indexes),
        ...
        log_line = (
            ...
            f"{len(pair_of_tokens_to_indexes):>10,} | "
